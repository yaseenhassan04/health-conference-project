    ...
    >
      <img
        ...
        onError={(e) => {
          ...
          e.currentTarget.src = `https://ui-avatars.com/api/?background=1B365D&color=D4AF37&bold=true&size=300&name=${encodeURIComponent(name)}`;
        }}
      />
    </div>
  );
      ...
      >
        ...
        >
          <img
            ...
            onError={(e) => {
              e.currentTarget.src = `https://ui-avatars.com/api/?background=1B365D&color=D4AF37&bold=true&size=200&name=${encodeURIComponent(president.name)}`;
            }}
          />
        </div>
...
/* ─── NewsTicker ─── */
function NewsTicker({ newsItems, newsLoading, t, isRtl, onClickItem }) {
      ...
      <style suppressHydrationWarning>{`
        ...
        *,*::before,*::after{box-sizing:border-box;margin:0;padding:0;}
        ...
        @media(max-width:1099px){
          .main-layout{flex-direction:column!important;gap:16px;width:100%!important;max-width:100%!important;align-items:stretch!important;}
          .sidebar-r,.sidebar-l{width:100%!important;max-width:100%!important;position:static!important;border-radius:0!important;}
        }
                      ...
                      >
                        ...
                        >
                          <img
                            ...
                            onError={(e) => {
                              e.currentTarget.src = `https://ui-avatars.com/api/?background=1B365D&color=D4AF37&bold=true&size=300&name=${encodeURIComponent(d.name)}`;
                            }}
                          />
                        </div>
                        <div
                      ...
                      <div style={{ overflow: "hidden" }}>
                        <div
                          style={{
                            display: "flex",
                            alignItems: "flex-start",
                            background: `linear-gradient(135deg,${B},#2a4a7a)`,
                            padding: isMobile
                              ? "24px 18px 20px"
                              : "32px 28px 24px",
                            position: "relative",
                        ...
                        >
                          ...
                          >
                            ...
                            >
                              <img
                                src={c.head.image || "/president.png"}
                                alt={c.head.name}
                                style={{
                                  width: "100%",
                                  height: "100%",
                                ...
                                onError={(e) => {
                                  e.currentTarget.src = `https://ui-avatars.com/api/?background=1B365D&color=D4AF37&bold=true&size=300&name=${encodeURIComponent(c.head.name)}`;
                                }}
                              />
                            </div>
                            <div
                        ...
                        >
                          ...
                          <div
                            style={{
                              background:
                                "linear-gradient(135deg,#fef9ee,#fff8e6)",
                              borderRadius: 14,
                              border: `1px solid ${G}35`,
                              padding: "16px 18px",
                            }}
